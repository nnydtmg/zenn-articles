...
| **Kimi K2 (Amazon Bedrock)** | スライド生成に使用するLLM |
...
bedrock_model = BedrockModel(
    model_id=bootstrap.MODEL_ID,  # Kimi K2
...
Marpスライドの生成には長い出力と高い指示追従性が求められます。Kimi K2はコンテキスト長が大きく、コード・Markdownの生成精度が高いため採用しました。Amazon Bedrock経由で利用できるため、認証管理がAWSに統一できる点もメリットです。
